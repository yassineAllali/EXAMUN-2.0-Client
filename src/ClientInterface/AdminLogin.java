...
public class AdminLogin extends JPanel 
{
	...
	public AdminLogin(JFrame frame) 
	{
		...
		ImageIcon poster = new ImageIcon(Home.class.getResource("/AppRessources/administration_poster.jpg"));
		...
		JLabel lblNewLabel_1 = new JLabel("Nom d'utilisateur Administrateur");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				else
				{
					...
					{
						Professeur admin = manager.chercherProf(userField.getText());
						db.closeConnection();
						if(!admin.isAdmin())
						{
							JOptionPane.showMessageDialog(null, "Vous n'avez pas le droit d'acceder à cette section!");
							ComponentManipulator.setError(errorUser, "Vous n'avez pas le droit d'acceder à cette section!");
						}
						else
						{
